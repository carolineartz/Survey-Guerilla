...
#user responses
SurveyResponse.create(participation_id: 1, choice_id: 2)
SurveyResponse.create(participation_id: 2, choice_id: 4)
SurveyResponse.create(participation_id: 3, choice_id: 6)
SurveyResponse.create(participation_id: 4, choice_id: 7)
SurveyResponse.create(participation_id: 5, choice_id: 3)
