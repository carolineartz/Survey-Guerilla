...
# questions
q1 = Question.create(question_text: "Who is your favorite Marvel Villian?", survey_id: marvel_survey.id)
  q1c1 = Choice.create(choice_text: "Mandarin", question_id: q1.id)
  q1c2 = Choice.create(choice_text: "Magneto", question_id: q1.id)

q2 = Question.create(question_text: "Who founded Marvel?", survey_id: marvel_survey.id)
  q2c1 = Choice.create(choice_text: "Stan Lee", question_id: q2.id)
  q2c2 = Choice.create(choice_text: "Bruce Banner", question_id: q2.id)

q3 = Question.create(question_text: "What year was Marvel founded?", survey_id: marvel_survey.id)
